      ...
      <div class="info-col-grid">
        ...
        <div class="quick-card">
          ...
          <div class="quick-item">
            <div class="quick-icon"><iconify-icon icon="solar:whatsapp-outline"></iconify-icon></div>
            <div class="quick-item-text">
              <strong>WhatsApp</strong>
              <a href="https://wa.me/{{ $siteSettings['footer_phone'] ?? '' }}">{{ $siteSettings['footer_phone'] ?? '' }}</a>
            </div>
          </div>
          <div class="quick-item">
            <div class="quick-icon"><iconify-icon icon="solar:letter-outline"></iconify-icon></div>
            <div class="quick-item-text">
              <strong>Email</strong>
              <a href="mailto:{{ $siteSettings['footer_email'] ?? '' }}">{{ $siteSettings['footer_email'] ?? '' }}</a>
            </div>
          </div>
        </div>
