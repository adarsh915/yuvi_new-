                ...
                <div class="col-md-8">
                    <div class="row gy-20">
                        <div class="col-12">
                            ...
                            <input type="text" id="service_title" name="title" class="form-control radius-8" placeholder="e.g. IVF & Assisted Reproduction" required>
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-semibold text-sm mb-8">Slug</label>
                            <input type="text" id="service_slug" name="slug" class="form-control radius-8" placeholder="auto-generated-from-title">
                        </div>
