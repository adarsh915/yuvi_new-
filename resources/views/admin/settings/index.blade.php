                            ...
                            <div class="col-md-6 border-end">
                                ...
                                <div class="logo-preview-wrapper">
                                    ...
                                    <img src="{{ asset(str_contains($hLogo, 'settings/') ? 'storage/' . $hLogo : $hLogo) }}"
                                        alt="Header Logo" style="max-height: 80px; object-fit: contain;">
                                </div>
                                ...
                                <p class="text-xs text-secondary-light mt-8">
                                    ...
                                    Recommended: 650x450px (PNG with transparency)
                                </p>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="logo-preview-wrapper">
                                    ...
                                    <img src="{{ asset(str_contains($fLogo, 'settings/') ? 'storage/' . $fLogo : $fLogo) }}"
                                        alt="Footer Logo" style="max-height: 80px; object-fit: contain;">
                                </div>
                    ...
                    <div class="card-body p-24">
                        <div class="row gy-4">
                            <div class="col-md-12">
                                ...
                                <textarea name="settings[footer_description]" class="form-control" rows="4"
                                    placeholder="Brief about the clinic...">{{ $settings->where('key', 'footer_description')->first()->value ?? '' }}</textarea>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label mb-8">Support Email</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><iconify-icon
                                            icon="solar:letter-outline"></iconify-icon></span>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><iconify-icon
                                            icon="solar:phone-outline"></iconify-icon></span>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light"><iconify-icon
                                            icon="solar:map-point-outline"></iconify-icon></span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-20">
                                    ...
                                    <input type="text" name="settings[media_banner_title]" class="form-control"
                                        value="{{ $settings->where('key', 'media_banner_title')->first()->value ?? '' }}"
                                        placeholder="e.g. Stories, Science & Clinical Insights">
                                </div>
                                <div class="mb-0">
                                    <label class="form-label mb-8">Banner Description</label>
                                    <textarea name="settings[media_banner_description]" class="form-control" rows="4"
                                        placeholder="Brief description for the media page...">{{ $settings->where('key', 'media_banner_description')->first()->value ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
