    ...
    <div class="page">
        ...
        <section class="submission">
            <div class="submission__head">
                ...
                <span>{{ $submission->phone }} | {{ $submission->email ?? 'N/A' }} |
                    {{ $submission->city ?? 'N/A' }}</span>
            </div>
            @php
                $yesCount = 0;
                $noCount = 0;
            ...
            @endphp
            <div class="info-grid"
                style="grid-template-columns: repeat(3, 1fr); border-bottom: 2px solid var(--border); background: #fff;">
                ...
                <div class="info-item" style="border-right: 1px solid var(--border); padding-right: 10px;">
                    ...
                    <div style="color: #059669; font-weight: 700;">{{ $yesCount }}</div>
                </div>
                <div class="info-item">
                    <label>No Responses</label>
                    <div style="color: #dc2626; font-weight: 700;">{{ $noCount }}</div>
                </div>
            </div>
            <div class="info-grid">
                <div class="info-item">
