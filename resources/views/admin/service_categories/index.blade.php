...
@php
    ...
    $subTitle = 'Manage Clinic Services Sections';
    $script = '
        <script>
            ...
            function editCategory(id, name, order, is_active) {
                ...
                $("#editForm").attr("action", "/admin/service-categories/" + id);
            }
        </script>
    ';
@endphp
        ...
        <div class="card p-24 radius-12 bg-base">
            ...
            <form action="{{ route('admin.service.categories.store') }}" method="POST">
                ...
                <div class="mb-20">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="e.g. IVF Success, Infertility" required>
                </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button class="btn btn-sm btn-outline-info d-flex align-items-center justify-content-center" 
                                                ...
                                                onclick='editCategory({{ $category->id }}, {{ json_encode($category->name) }}, {{ $category->order }}, {{ $category->is_active ? 1 : 0 }})'>
