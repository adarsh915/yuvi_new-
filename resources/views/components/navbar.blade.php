                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        ...
                        <ul class="to-top-list">
                            ...
                            <li>
                                <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3" href="{{ route('admin.settings') }}">
                                    <iconify-icon icon="icon-park-outline:setting-two" class="icon text-xl"></iconify-icon> Site Settings
                                </a>
                            </li>
                            <li>
